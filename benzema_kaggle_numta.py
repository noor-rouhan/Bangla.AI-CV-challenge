...
X_train_all = X_train_all.reshape(X_train_all.shape[0],28, 28,3).astype('float32')
X_test_all = X_test_all.reshape(X_test_all.shape[0],28, 28,3).astype('float32')
...
featuresTrain = model.predict(X_train_all,verbose=1)
featuresTest = model.predict(X_test_all,verbose=1)
del model
del X_train_all
del X_test_all
